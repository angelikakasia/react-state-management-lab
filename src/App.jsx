...
const App = () => {
  let totalSt=0;
  const [team, setTeam] = useState([]); //empty array
  const [money, setMoney] = useState(100);

  team.map((fighter)=>{

    totalSt= totalSt + Number(fighter.strength);
  ...
  let totalAg = 0;
  team.map((fighter)=>{
    totalAg += Number(fighter.agility);
    return totalAg;
  })
  const totalAgility = totalAg;
  const totalStrength = totalSt;
  ...
  },
  {
    ...
    img: 'https://pages.git.generalassemb.ly/modular-curriculum-all-courses/react-state-management-lab/assets/e41f26.png',
      ...
      setZombieFighter(updatedFighters);
